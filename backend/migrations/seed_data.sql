-- Seed Data Script for PlaySpot
-- This script inserts basic/default data into the database
...
INSERT INTO facilities (id, name, sport_complex_id, manager_id, category_id, surface_id, environment_id, description, capacity, is_verified, is_active) VALUES
    ...
    (3, 'Tennis Court A', NULL, 1, 1, 6, 2, 'Professional acrylic tennis court', 50, TRUE, TRUE),
...
-- Remove expired/used/revoked tokens when seeding
DELETE FROM tokens WHERE expires_at < NOW() OR used = TRUE OR revoked = TRUE;
